...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 01 | 0:00-0:15 | setup | product/before-after-demo | hyperframes | not_required | no | 기존 Controller/Service/Repository/Entity 구조 | not_required | layer stack | role badges | standard | layer labels | not_required | no | 기존에는 앱을 레이어로 나눔 | HTML/SVG | composition | n/a | n/a | implement in Hyperframes | inputs_ready | inputs_ready |
