...
> `factory:review-video` creates evidence. A human editor or `hype-video-reviewer` must inspect the frames and set `Verdict: PASS` only after the rendered video works as a YouTube/motion piece.

## Evidence To Inspect

- Contact sheet: `review/video-review/contact-sheet.jpg`
